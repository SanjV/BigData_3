...
import org.apache.spark.mllib.clustering.{KMeans, KMeansModel}
    ...
    val movieData=sc.textFile("/home/sanjana/Downloads/movies.dat").map(line=>line.split("::",2)).map(line=>(line(0)->line(1))).collect().toMap;
    val data = sc.textFile("/home/sanjana/Downloads/itemusermat")
